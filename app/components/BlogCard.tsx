...
const BlogCard = async () => {
    ...
    return (
        <div>
            {data.map((post, idx) => {
                return (
                    <div className="sm:flex p-8 m-10 justify-between ease-in duration-300 border-2 hover:border-sky-500 rounded-2xl" key={idx}>
                        ...
                        <Image
                            className="rounded-xl w-[100%] sm:w-52 ml-8"
